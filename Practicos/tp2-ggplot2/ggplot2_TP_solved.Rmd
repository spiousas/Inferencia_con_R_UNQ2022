...
dictionary_tbl <- read_csv(here("Practicos/tp1-tidyverse/data/dictionary.csv"))
summer_tbl <- read_csv(here("Practicos/tp1-tidyverse/data/summer.csv"))
...
winter_tbl <- read_csv(here("Practicos/tp1-tidyverse/data/winter.csv"))
